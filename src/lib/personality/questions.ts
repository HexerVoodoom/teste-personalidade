 ...
 *
 * `tags` carry a provisional archetype vocabulary (element / role) that exists
 * to be replaced by the real bestiário tag set once that project is wired in.
 */
...
const likert: LikertItem[] = [
  ...
  { id: "O-ima-1", kind: "likert", dimension: "openness", facet: "imaginação", positive: true,
    text: "Passo bastante tempo imaginando cenários e possibilidades que ainda não existem.",
    tags: ["ar", "arcano"], consistencyPair: "O-ima" },
  { id: "O-ima-2", kind: "likert", dimension: "openness", facet: "imaginação", positive: false,
    text: "Prefiro lidar com o que é concreto a ficar divagando sobre hipóteses.",
    tags: ["terra"], consistencyPair: "O-ima" },
  ...
  { id: "C-org-1", kind: "likert", dimension: "conscientiousness", facet: "organização", positive: true,
    text: "Gosto que minhas coisas e meus compromissos estejam em ordem.",
    tags: ["terra", "guardião"], consistencyPair: "C-org" },
  { id: "C-org-2", kind: "frequency", dimension: "conscientiousness", facet: "organização", positive: false,
    text: "Com que frequência você perde algo por não lembrar onde guardou?",
    tags: ["caos"], consistencyPair: "C-org" },
  // Facet: persistência
  ...
  { id: "E-soc-1", kind: "likert", dimension: "extraversion", facet: "sociabilidade", positive: true,
    text: "Estar com bastante gente me deixa mais animado, não mais cansado.",
    tags: ["fogo", "vanguarda"], consistencyPair: "E-soc" },
  { id: "E-soc-2", kind: "likert", dimension: "extraversion", facet: "sociabilidade", positive: false,
    text: "Depois de muito convívio social, preciso de um tempo sozinho para me recuperar.",
    tags: ["sombra"], consistencyPair: "E-soc" },
  // Facet: assertividade
  ...
  { id: "A-emp-2", kind: "likert", dimension: "agreeableness", facet: "empatia", positive: false,
    ...
    tags: ["ar", "estrategista"] },
  // Facet: cooperação
  { id: "A-coo-1", kind: "likert", dimension: "agreeableness", facet: "cooperação", positive: true,
    text: "Prefiro ceder um pouco a transformar uma divergência em briga.",
    tags: ["água", "suporte"], consistencyPair: "A-coo" },
  { id: "A-coo-2", kind: "frequency", dimension: "agreeableness", facet: "cooperação", positive: false,
    text: "Com que frequência você entra em discussões acaloradas para defender seu ponto?",
    tags: ["fogo", "vanguarda"], consistencyPair: "A-coo" },
  // Facet: confiança
  ...
  { id: "A-con-2", kind: "likert", dimension: "agreeableness", facet: "confiança", positive: false,
    ...
    tags: ["sombra", "estrategista"] },

  // ============================ NEUROTICISMO ===========================
  // Facet: ansiedade
  { id: "N-ans-1", kind: "frequency", dimension: "neuroticism", facet: "ansiedade", positive: true,
    text: "Com que frequência você se preocupa com coisas que talvez nem aconteçam?",
    tags: ["sombra", "instável"], consistencyPair: "N-ans" },
  { id: "N-ans-2", kind: "likert", dimension: "neuroticism", facet: "ansiedade", positive: false,
    text: "Encaro situações incertas com bastante tranquilidade.",
    tags: ["terra", "guardião"], consistencyPair: "N-ans" },
  // Facet: volatilidade
  ...
  { id: "N-est-2", kind: "likert", dimension: "neuroticism", facet: "vulnerabilidade ao estresse", positive: false,
    ...
    tags: ["terra", "guardião", "vanguarda"] },

  // ====================== HONESTIDADE-HUMILDADE ========================
  // Facet: sinceridade
  { id: "H-sin-1", kind: "likert", dimension: "honestyHumility", facet: "sinceridade", positive: true,
    text: "Não me sinto confortável em manipular alguém, mesmo que fosse dar certo.",
    tags: ["luz", "guardião"], consistencyPair: "H-sin" },
  { id: "H-sin-2", kind: "likert", dimension: "honestyHumility", facet: "sinceridade", positive: false,
    text: "Se bajular alguém for o caminho mais fácil para conseguir o que quero, eu bajulo.",
    tags: ["sombra", "estrategista"], consistencyPair: "H-sin" },
  // Facet: modéstia
...
const forcedChoice: ForcedChoiceItem[] = [
  ...
  { id: "J-EI-1", kind: "forced-choice", dimension: "EI", facet: "fonte de energia",
    ...
    a: { text: "Sair e estar com gente de quem eu gosto", tags: ["fogo"] },
    b: { text: "Um tempo sozinho, no meu ritmo", tags: ["sombra"] } },
  { id: "J-EI-2", kind: "forced-choice", dimension: "EI", facet: "processamento",
    prompt: "Quando você precisa resolver algo complicado:",
    a: { text: "Falo sobre o assunto com alguém e vou pensando enquanto falo", tags: ["fogo"] },
    b: { text: "Fico remoendo por dentro até chegar a uma conclusão", tags: ["sombra", "arcano"] } },
  { id: "J-EI-3", kind: "forced-choice", dimension: "EI", facet: "amplitude social",
    prompt: "O que descreve melhor o seu círculo?",
    a: { text: "Muita gente, contatos variados, sempre conhecendo alguém novo", tags: ["fogo", "explorador"] },
    b: { text: "Poucas pessoas, mas laços profundos e duradouros", tags: ["água", "sombra"] } },
  ...
  { id: "J-SN-1", kind: "forced-choice", dimension: "SN", facet: "foco perceptivo",
    ...
    a: { text: "Dados concretos e no que já foi testado na prática", tags: ["terra", "precisão"] },
    b: { text: "No padrão que você percebe e no potencial que aquilo tem", tags: ["arcano", "ar"] } },
  { id: "J-SN-2", kind: "forced-choice", dimension: "SN", facet: "orientação temporal",
    prompt: "Sua atenção fica mais em:",
    a: { text: "O que existe agora e o que precisa ser feito hoje", tags: ["terra"] },
    b: { text: "O que isso pode virar daqui a alguns anos", tags: ["arcano"] } },
  { id: "J-SN-3", kind: "forced-choice", dimension: "SN", facet: "estilo de aprendizado",
    prompt: "Você aprende melhor quando:",
    a: { text: "Alguém te mostra o passo a passo e você repete", tags: ["terra", "precisão"] },
    b: { text: "Você entende o conceito por trás e deduz o resto", tags: ["arcano"] } },
  ...
  { id: "J-TF-1", kind: "forced-choice", dimension: "TF", facet: "critério de decisão",
    ...
    a: { text: "Qual opção é mais justa e coerente, olhando de fora", tags: ["ar", "estrategista"] },
    b: { text: "Como cada pessoa envolvida vai ser afetada", tags: ["água", "curandeiro"] } },
  { id: "J-TF-2", kind: "forced-choice", dimension: "TF", facet: "estilo de feedback",
    prompt: "Ao dar um retorno difícil, você tende a:",
    a: { text: "Ser direto — a pessoa precisa saber o problema com clareza", tags: ["ar", "vanguarda"] },
    b: { text: "Cuidar do tom — a forma importa tanto quanto o conteúdo", tags: ["água", "suporte"] } },
  { id: "J-TF-3", kind: "forced-choice", dimension: "TF", facet: "valor central",
    prompt: "Se tivesse que escolher um para preservar:",
    a: { text: "A verdade, mesmo que ela desestabilize o grupo", tags: ["ar", "estrategista"] },
    b: { text: "A harmonia, mesmo que algo fique não dito", tags: ["água"] } },
  ...
  { id: "J-JP-1", kind: "forced-choice", dimension: "JP", facet: "estrutura",
    ...
    a: { text: "Planejada, com roteiro e reservas feitas", tags: ["terra", "guardião"] },
    b: { text: "Em aberto, decidindo os próximos passos no caminho", tags: ["caos", "explorador"] } },
  { id: "J-JP-2", kind: "forced-choice", dimension: "JP", facet: "relação com prazos",
    prompt: "Sua relação com prazos:",
    a: { text: "Entrego antes; deixar para depois me deixa desconfortável", tags: ["terra"] },
    b: { text: "Rendo mais com o prazo em cima", tags: ["caos"] } },
  { id: "J-JP-3", kind: "forced-choice", dimension: "JP", facet: "tomada de decisão",
    prompt: "Diante de várias opções, você prefere:",
    a: { text: "Decidir logo e seguir em frente", tags: ["terra", "vanguarda"] },
    b: { text: "Manter as portas abertas o máximo possível", tags: ["caos", "explorador"] } },
];
...
const scenarios: ScenarioItem[] = [
  {
    ...
    options: [
      { id: "a", text: "Assumo o comando, redistribuo as tarefas e cobro cada um.",
        weights: { conscientiousness: 4, extraversion: 4, agreeableness: 1, neuroticism: 1 }, tags: ["fogo", "vanguarda"] },
      { id: "b", text: "Faço eu mesmo a parte que falta, sem criar atrito.",
        weights: { conscientiousness: 4, extraversion: 1, agreeableness: 3, neuroticism: 2 }, tags: ["terra", "suporte"] },
      { id: "c", text: "Chamo o grupo para conversar e entender o que travou cada um.",
        weights: { conscientiousness: 2, extraversion: 3, agreeableness: 4, neuroticism: 1 }, tags: ["água", "curandeiro"] },
      { id: "d", text: "Fico ansioso, mas espero que alguém tome a frente.",
        weights: { conscientiousness: 0, extraversion: 0, agreeableness: 2, neuroticism: 4 }, tags: ["sombra", "instável"] },
    ],
  },
  {
    ...
    options: [
      { id: "a", text: "Aceito rápido — a novidade em si já vale o risco.",
        weights: { openness: 4, conscientiousness: 1, neuroticism: 1 }, tags: ["ar", "explorador"] },
      { id: "b", text: "Monto uma planilha, avalio cenários e decido com calma.",
        weights: { openness: 3, conscientiousness: 4, neuroticism: 1 }, tags: ["terra", "estrategista"] },
      { id: "c", text: "Recuso: o que eu já construí aqui vale mais que a aposta.",
        weights: { openness: 1, conscientiousness: 3, neuroticism: 2 }, tags: ["terra", "guardião"] },
      { id: "d", text: "Fico dias sem dormir pensando nisso e adio a resposta.",
        weights: { openness: 2, conscientiousness: 0, neuroticism: 4 }, tags: ["sombra", "instável"] },
    ],
  },
  {
    ...
    options: [
      { id: "a", text: "Assumo na hora, mesmo com o custo de imagem.",
        weights: { honestyHumility: 4, conscientiousness: 4, neuroticism: 1 }, tags: ["luz", "guardião"] },
      { id: "b", text: "Corrijo discretamente e não menciono para ninguém.",
        weights: { honestyHumility: 2, conscientiousness: 3, neuroticism: 2 }, tags: ["sombra", "precisão"] },
      { id: "c", text: "Deixo como está: o estrago seria maior do que o erro.",
        weights: { honestyHumility: 0, conscientiousness: 1, neuroticism: 2 }, tags: ["sombra", "estrategista"] },
      { id: "d", text: "Fico remoendo a culpa por semanas sem decidir o que fazer.",
        weights: { honestyHumility: 3, conscientiousness: 1, neuroticism: 4 }, tags: ["água", "instável"] },
    ],
  },
  {
    ...
    options: [
      { id: "a", text: "Falo com franqueza o que penso, mesmo que ele não queira ouvir.",
        weights: { agreeableness: 1, extraversion: 3, honestyHumility: 4 }, tags: ["fogo", "vanguarda"] },
      { id: "b", text: "Faço perguntas até ele mesmo enxergar os furos.",
        weights: { agreeableness: 3, extraversion: 2, honestyHumility: 3 }, tags: ["ar", "estrategista"] },
      { id: "c", text: "Apoio a decisão dele — não é minha vida.",
        weights: { agreeableness: 4, extraversion: 1, honestyHumility: 2 }, tags: ["água", "suporte"] },
      { id: "d", text: "Concordo na frente dele e comento com outra pessoa depois.",
        weights: { agreeableness: 2, extraversion: 2, honestyHumility: 0 }, tags: ["sombra"] },
    ],
  },
  {
    ...
    options: [
      { id: "a", text: "Começo um projeto criativo que estava engavetado.",
        weights: { openness: 4, extraversion: 2, conscientiousness: 3 }, tags: ["ar", "criador"] },
      { id: "b", text: "Chamo gente para fazer algo junto.",
        weights: { openness: 2, extraversion: 4, conscientiousness: 1 }, tags: ["fogo"] },
      { id: "c", text: "Adianto pendências e organizo o que estava atrasado.",
        weights: { openness: 1, extraversion: 1, conscientiousness: 4 }, tags: ["terra", "guardião"] },
      { id: "d", text: "Descanso sem plano nenhum e vejo no que dá.",
        weights: { openness: 2, extraversion: 1, conscientiousness: 0 }, tags: ["caos", "explorador"] },
    ],
  },
  {
    ...
    options: [
      { id: "a", text: "Rebato na hora e defendo meu trabalho.",
        weights: { neuroticism: 2, agreeableness: 0, honestyHumility: 2, extraversion: 4 }, tags: ["fogo", "vanguarda"] },
      { id: "b", text: "Escuto, considero se há razão e respondo depois com calma.",
        weights: { neuroticism: 1, agreeableness: 3, honestyHumility: 4, extraversion: 2 }, tags: ["terra", "estrategista"] },
      { id: "c", text: "Fico abalado e reviso tudo o que fiz procurando o erro.",
        weights: { neuroticism: 4, agreeableness: 3, honestyHumility: 3, extraversion: 1 }, tags: ["água", "instável"] },
      { id: "d", text: "Não deixo transparecer nada e sigo como se não fosse comigo.",
        weights: { neuroticism: 2, agreeableness: 2, honestyHumility: 1, extraversion: 0 }, tags: ["sombra"] },
    ],
  },
];
